 ...
 */
function parse(data) {
    var bodyStr = data.toString().substring(data.toString().indexOf("\r\n\r\n"));
    var bodyIdx = data.toString().indexOf(bodyStr) || data.toString().length;
    var headers = data.toString().substring(0, bodyIdx).split("\n");
